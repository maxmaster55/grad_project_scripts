...
with rasterio.open('../tile_3_2_r.tif', mode='r') as src:
    img = src.read()
    print(img.shape)
...
def process_image(image_path, output_dir, ndvi_t, ndwi_t, ndbi_t, save_format="png", image_number=1):
    ...
    multiclass_mask = create_multiclass_mask(ndvi, ndwi, ndbi, ndvi_t, ndwi_t, ndbi_t)
...
if __name__ == "__main__ ":
    ...
    parser.add_argument("--ndvi", type=float, default=0.5, help="NDVI threshold.")
    parser.add_argument("--ndwi", type=float, default=0.95, help="NDWI threshold.")
    parser.add_argument("--ndbi", type=float, default=0.9, help="NDBI threshold.")
